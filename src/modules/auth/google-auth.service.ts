...
import { GoogleTokenResponse, GoogleUserInfo, GoogleTokenInfo } from './auth.dto';
...
export class GoogleAuthService {
    ...
    constructor(
        ...
        const redirectUri = this.configService.get<string>('FRONTEND_URL_GOOGLE_REDIRECT');
    ...
    async exchangeCodeForToken(code: string, path: string = 'security'): Promise<GoogleTokenResponse> {
        try {
            ...
            const redirectUri = this.configService.get<string>('FRONTEND_URL_GOOGLE_REDIRECT') + '/' + path;
